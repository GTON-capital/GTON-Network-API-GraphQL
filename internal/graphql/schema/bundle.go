...
type Query {
  ...
  # Get a scrollable list of epochs sorted from the last one back by sault.
  ...
  fMintUserTokens(
    purpose: FMintUserTokenPurpose = FMINT_COLLATERAL
  ): [FMintUserToken!]!
